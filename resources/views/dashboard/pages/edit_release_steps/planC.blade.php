<ul class="nav nav-tabs" id="registerTabs" style="margin-top:60px;">
                                ...
                                <div class="tab-content p-3 border border-top-0">
                                  <input type="hidden" name="release_id" id="release_id" value="{{$release_music->id ?? ''}}">
                                        ...
                                        <form id="formStep1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                            ...
                                                            <input type="text" name="release_title" class="form-control" value="{{$release_music->release_title ?? ''}}">
                                                            <span style="margin-bottom: 16px;" class="text-danger error-text release_title_error"></span>
                                                </div>
                                                <div class="col-md-6">
                                                            <label>Stereo ID Type</label>
                                                            <input type="text" name="stereo_type" class="form-control" value="{{$release_music->stereo_type ?? ''}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                            ...
                                                            <input type="number" name="stereo_code" class="form-control" value="{{$release_music->stereo_code ?? ''}}">
                                                            <span style="margin-bottom: 16px;" class="text-danger error-text stereo_code_error"></span>
                                                </div>
                                                <div class="col-md-6">
                                                            <label>Label Name</label>
                                                            <input type="text" name="label_name" class="form-control" value="{{$release_music->label_name ?? ''}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                            ...
                                                            <input type="date" name="release_date" class="form-control" value="{{$release_music->release_date ?? ''}}">
                                                    ...
                                                    <div class="form-switch switch-primary d-flex align-items-center gap-3">
                                                        <span>
                                                            <div class="image-preview" id="imagePreview">
                                                                @if(!empty($release_music->artwork_image))
                                                                    <img src="{{ Storage::url($release_music->artwork_image ?? '') }}" 
                                                                        alt="Artwork" style="max-width: 200px; max-height: 200px;">
                                                                @else
                                                        ...
                                                        <span style="margin-left: 150px;margin-top: -30px;">
                                                            ...
                                                            <p class="card-text text-neutral-600">
                                                                Stores will reject images that contain URLs, logos or branding, blurry or pixelated images without permission, images with prices or references to physical packaging, and pornographic imagery.
                                                            </p> 
                                                        </span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane fade" id="step3">
                                        <form id="formStep3" enctype="multipart/form-data">
                                            ...
                                            <div style="margin-top:20px;" class="alert alert-warning bg-transparent text-warning-600 border-warning-600 px-24 py-11 mb-0 fw-semibold text-lg radius-8 d-flex" role="alert">
                                                💡
                                                <p style="color:#4B5563;" class="mb-0 text-sm">
                                                    To avoid release delay or rejection, please ensure that there is no silence longer than 20 seconds before or after the music, and that the song does not end abruptly
                                                </p>
                                            </div>
                                                    ...
                                                    <div class="form-switch switch-primary d-flex align-items-center gap-3">
                                                        <div class="audio-preview" id="audioPreview">
                                                            @if(!empty($release_music->audioUpload))
                                                                <audio controls>
                                                                    <source src="{{ Storage::url($release_music->audioUpload) }}" type="audio/mpeg">
                                                                    Your browser does not support the audio element.
                                                                </audio>
                                                                @php
                                                                    $filePath = Storage::url($release_music->audioUpload);
                                                                    $sizeMB = file_exists($filePath) ? number_format(filesize($filePath) / (1024*1024), 2) : '0.00';
                                                                @endphp
                                        ...
                                        <form id="formStep4" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="track_details" class="form-control" value="{{$release_music->track_details ?? ''}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                        ...
                                                        <select name="genre[]" multiple="multiple" class="form-control js-example-basic-multiple" style="width: 100% !important">
                                                         ...
                                                         @php
                                                            $selectedGenres = json_decode($release_music->genre ?? '[]', true) ?? [];
                                                         @endphp
                                                          
                                                          @foreach($genres as $value)
                                                              <option value="{{$value->name}}" @if(in_array($value->name, $selectedGenres)) selected @endif>{{$value->name}}</option>
                                                          @endforeach
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="featured_artist" class="form-control" value="{{$release_music->featured_artist ?? ''}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <label>ISRC</label>
                                                        <input type="text" name="isrc" class="form-control" placeholder="Enter ISRC" value="{{$release_music->isrc ?? ''}}">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="iswc" class="form-control" value="{{$release_music->iswc ?? ''}}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <select name="instrumental" class="form-control js-example-basic-single" style="width: 100% !important">
                                                            ...
                                                            <option value="Yes" {{ old('instrumental', $release_music->instrumental ?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                                            <option value="No" {{ old('instrumental', $release_music->instrumental ?? '') == 'No' ? 'selected' : '' }}>No</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <select name="language" class="form-control js-example-basic-single" style="width: 100% !important">
                                                                ...
                                                                @foreach($languages as $value)
                                                                  <option value="{{$value->name}}" {{$value->name == ($release_music?->language ?? '')  ? 'selected' : ''}}>{{$value->name}}</option>
                                                                @endforeach
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <select name="parent_advice" class="form-control js-example-basic-single" style="width: 100% !important">
                                                            <option value="Clean" {{ old('parent_advice', $release_music?->parent_advice) == 'Clean' ? 'selected' : '' }}>Clean</option>
                                                            <option value="Explicit" {{ old('parent_advice', $release_music?->parent_advice) == 'Explicit' ? 'selected' : '' }}>Explicit</option>
                                                            <option value="Not Required" {{ old('parent_advice', $release_music?->parent_advice) == 'Not Required' ? 'selected' : '' }}>Not Required</option>
                                                        </select>
                                                ...
                                                <div class="col-md-6">
                                                        ...
                                                        <select name="stream_type[]" multiple="multiple" class="form-control js-example-basic-multiple" style="width: 100% !important">
                                                            <option value="Download" {{ in_array('Download', old('stream_type', json_decode($release_music?->stream_type) ?? [])) ? 'selected' : '' }}>Download</option>
                                                            <option value="Stream" {{ in_array('Stream', old('stream_type', json_decode($release_music?->stream_type) ?? [])) ? 'selected' : '' }}>Stream</option>
                                                        </select>
                                                    ...
                                                    <td>
                                                        <div class="form-check style-check d-flex align-items-center">
                                                            <input class="form-check-input row-checkbox"
                                                                  ...
                                                                  value="{{ $store?->id }}"
                                                                  id="store-{{ $store?->id }}"
                                                                  {{ in_array($store?->id, old('stores', json_decode($release_music->stores ?? '[]', true) ?? [])) ? 'checked' : '' }}>
