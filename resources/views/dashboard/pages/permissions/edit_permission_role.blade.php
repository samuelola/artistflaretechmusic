...
">
       <div class="card-body p-24">
           ...
           <div class="row">
                ...
                <div class="col-md-6">
                     <form method="post" action="{{route('update_permission_role')}}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="exampler" name="role_ids[]" class="form-control js-example-basic-singlee" multiple="multiple" style="width: 100% !important">
                                 
                                @foreach($roles as $role)
                                    <option value="{{$role->id}}" @if(in_array($role->id, $selectedRoleIds)) selected @endif>{{$role->name}}</option>
                                @endforeach
