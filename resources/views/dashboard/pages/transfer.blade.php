            ...
            <div class="card p-0 overflow-hidden position-relative radius-12 h-100">
                ...
                <div class="card-body p-24 pt-10">
                    ...
                    <div class="tab-content" id="pills-tab-fourContent">
                                 ...
                                 <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        Send Money to Bank
                                            ...
                                            <form style="margin-top:10px;" method="post" action="{{route('transfer_payment')}}">
                                                @csrf
                                                <div class="col-12">
                              ...
                              <div class=" align-items-center">
                                      <div class="row">
                                          ...
                                          <div class="col-md-6">
                                                ...
                                                <form style="margin-top:10px;" method="post" action="{{route('user_wallet_transfer')}}">
                                                    @csrf
                                                    <div class="col-12">
                                                    <label class="form-label">Enter Amount</label>
                                                    <input type="number" name="amount_b" min="1" class="form-control" value="{{ old('amount_b') }}">
                                                    ...
                                                    <div class="col-12 mt-3">
                                                        ...
                                                        <select name="recipient" class="form-control js-example-basic-single" style="width: 100% !important">
                                                          ...
                                                          @foreach($get_recipient as $val)
                                                              <option value="{{$val->user->id}}">{{$val->user->first_name}} {{$val->user->last_name}}--{{$val->user->email}}</option>
                                                          @endforeach
                        ...
                        <div class="tab-pane fade" id="pills-button-icon-coins" role="tabpanel" aria-labelledby="pills-button-icon-coins-tab" tabindex="0">
                              <div class=" align-items-center">
                                      <div class="row">
                                          ...
                                          <div class="col-md-6">
                                                <span class="text-yellow-500  mr-2">💡
                                                  Send FlareProCoins To Another Wallet
                                                </span>
                                                <form style="margin-top:10px;" method="post" action="{{route('user_coin_transfer')}}">
                                                    @csrf
                                                    <div class="col-12">
                                                    <label class="form-label">Enter Amount of coins</label>
                                                    <input type="number" name="amount_c" min="1" class="form-control" value="{{ old('amount_c') }}">
