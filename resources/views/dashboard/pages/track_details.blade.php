...
<main class="dashboard-main">
  ...
  <h6 class="fw-semibold mb-0">Tracks Details</h6>
    ...
    <div class="card">
        <div class="card-body">
             <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    <div class="card bg-soft-secondary" style="margin-top: 52px;">
                        <img src="{{asset('assets/images/card-component/walking3.jpg')}}" class="img-fluid w-100" alt="">
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="d-flex align-items-top justify-content-between" style="margin-top: 30px;margin-bottom: 30px;">
                        
                        <!--music player-->
                              <div id="single-song-player" style="box-shadow: none !important;">
                                    <!--music detail -->
                                          <div class="music-detail">
                                              <h3 style="font-size: 20px !important;" class="fw-bold">{{$track_user_detail->title}}</h3>
    ...
    font-size: 18px;
    color: #fff;
    display: block;"><span>By :</span>&nbsp;{{$track_user_detail->artist}}</span>
                            ...
                            <div class="iq-circle me-2 share"><a href="{{route('share_track',$track_user_detail->id)}}">
  ...
  songs: [
    {
      ...
      url: "{{config('app.website_storage_link')}}/storage/{{$track_user_detail->audioFile->path}}",
      cover_art_url:
